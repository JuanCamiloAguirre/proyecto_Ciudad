...
class ComprasEnc(ClassModelo):
    ...
    def save(self):
        ...
        self.total=self.sub_total - ((float(self.sub_total)*(float(self.descuento)))/100)
...
class ComprasDet(ClassModelo):
    ...
    def save(self):
        ...
        # self.total=self.sub_total - (self.sub_total*(self.descuento/100))
        # self.total=float(self.sub_total) - ((float(int(self.sub_total))*(float(int(self.descuento)))/100))
        self.total=self.sub_total - ((float(self.sub_total)*(float(self.descuento)))/100)
